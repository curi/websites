...
JP's answers should attempt to resolve the issues. The goal is to figure out the truth, not see which side can score more rhetorical points. If JP doesn't know how to resolve an issue immediately, he can say that. It's important to be objective about the state of knowledge of an issue, rather than only saying arguments to help "your" side. Being biased against arguments for the "other" side is different than impartially seeking the truth whatever it may be. It's like a scientist who writes down evidence his new drug works, but ignores all the times it doesn't work.
